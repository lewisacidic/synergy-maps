...
from synergy_maps import (RepresentationType, ActivityType, ReductionMethod,
SynergyType, TSNE, SynergyMap)
...
if __name__ == "__main__":
    sm = make_map()
    with open('../../../../frontend/app/data/NCATS-Malaria/data_try.json', 'w') as f:
